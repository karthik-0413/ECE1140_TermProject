...
#        This program represents the green line wayside controller.
...
class wayside_ui_green_line(object):
        ...
        # Speed
        ui_sugg_speed = [None] * 152
        ui_cmd_speed = [None] * 152
        ui_past_sugg_speed = []

        # Authority
        ui_sugg_authority = [None] * 152
        ui_cmd_authority = [None] * 152
        ui_past_cmd_authority = []

        # Switches      D   F   I   K  N1  N2
        ui_switches = [ 0,  1,  0,  1,  1,  0 ]
        ui_past_switches = []

        # Signals      C,  D,  F,  G,  J,  K, N1, N2,  O,  R, Yard
        ui_signals = [ 0,  1,  0,  1,  1,  0,  0,  1,  0,  1,    0 ]
        ...
        def data_table_speed(self):
                ...
                if self.WaysideSelectComboBox.currentIndex() == 1:
                        ...
                        for i in range(1, 33):
                                ...
                                temp_block_item.setText(f"{i if i != 7 else '7b'}")
                                ...
                                # Set items
                                self.DataTable.setItem(i-1, 0, temp_block_item)
                                self.DataTable.setItem(i-1, 1, temp_sugg_item)
                                self.DataTable.setItem(i-1, 2, temp_cmd_item)
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText("7a")
                        temp_sugg_item.setText(f'{f'{round(self.ui_sugg_speed[151] / 1.609)} mph' if self.ui_sugg_speed[151] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{round(self.ui_cmd_speed[151] / 1.609)} mph' if self.ui_cmd_speed[151] != None else "None"}')

                                # Insert row
                        self.DataTable.insertRow(6)

                                # Set items
                        self.DataTable.setItem(6, 0, temp_block_item)
                        self.DataTable.setItem(6, 1, temp_sugg_item)
                        self.DataTable.setItem(6, 2, temp_cmd_item)
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText(f"{150}")
                        temp_sugg_item.setText(f'{f'{round(self.ui_sugg_speed[150] / 1.609)} mph' if self.ui_sugg_speed[150] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{round(self.ui_cmd_speed[150] / 1.609)} mph' if self.ui_cmd_speed[150] != None else "None"}')
                        
                                # Set items
                        self.DataTable.setItem(33, 0, temp_block_item)
                        self.DataTable.setItem(33, 1, temp_sugg_item)
                        self.DataTable.setItem(33, 2, temp_cmd_item)

                        # Set item backgrounds
                        for i in range(34):

                                # Get number from item text
                                translated_value = self.translate_text_to_int(self.DataTable.item(i, 2).text())

                                # Set background
                                self.set_item_background(i, translated_value)

                # Wayside 2 Data
                elif self.WaysideSelectComboBox.currentIndex() == 2:
                        
                        # Set row count
                        self.DataTable.setRowCount(87)
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText(f"{'Yard'}")
                        temp_sugg_item.setText(f'{f'{round(self.ui_sugg_speed[0] / 1.609)} mph' if self.ui_sugg_speed[0] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{round(self.ui_cmd_speed[0] / 1.609)} mph' if self.ui_cmd_speed[0] != None else "None"}')

                                # Set background
                        self.set_item_background(0, self.ui_cmd_speed[0])

                                # Set items
                        self.DataTable.setItem(0, 0, temp_block_item)
                        self.DataTable.setItem(0, 1, temp_sugg_item)
                        self.DataTable.setItem(0, 2, temp_cmd_item)
                        ...
                        for i in range(33, 74):
                                ...
                                # Set background
                                self.set_item_background(i-32, self.ui_cmd_speed[i])

                                # Set items
                                self.DataTable.setItem(i-32, 0, temp_block_item)
                                self.DataTable.setItem(i-32, 1, temp_sugg_item)
                                self.DataTable.setItem(i-32, 2, temp_cmd_item)
                        ...
                        for i in range(105, 150):
                                ...
                                # Set background
                                self.set_item_background(i-63, self.ui_cmd_speed[i])

                                self.DataTable.setItem(i-63, 0, temp_block_item)
                                self.DataTable.setItem(i-63, 1, temp_sugg_item)
                                self.DataTable.setItem(i-63, 2, temp_cmd_item)
              
                # Wayside 3 Data
                elif self.WaysideSelectComboBox.currentIndex() == 3:
                        
                        # Set row count
                        self.DataTable.setRowCount(31)
                        ...
                        for i in range(74, 105):
                                ...
                                # Set background
                                self.set_item_background(i-74, self.ui_cmd_speed[i])

                                self.DataTable.setItem(i-74, 0, temp_block_item)
                                self.DataTable.setItem(i-74, 1, temp_sugg_item)
                                self.DataTable.setItem(i-74, 2, temp_cmd_item)
        ...
        def data_table_authority(self):
                ...
                if self.WaysideSelectComboBox.currentIndex() == 1:
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText("7a")
                        temp_sugg_item.setText(f'{f'{self.ui_sugg_authority[151]} blocks' if self.ui_sugg_authority[151] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{self.ui_cmd_authority[151]} blocks' if self.ui_cmd_authority[151] != None else "None"}')
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText(f"{150}")
                        temp_sugg_item.setText(f'{f'{self.ui_sugg_authority[150]} blocks' if self.ui_sugg_authority[150] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{self.ui_cmd_authority[150]} blocks' if self.ui_cmd_authority[150] != None else "None"}')
                        ...
                        for i in range(34):
                                ...
                                # Get number from item text
                                translated_value = self.translate_text_to_int(self.DataTable.item(i, 1).text())
                ...
                # Wayside 2 Data
                        ...
                        temp_cmd_item = QtWidgets.QTableWidgetItem()
                                ...
                                # Set item information
                        temp_block_item.setText(f"{'Yard'}")
                        temp_sugg_item.setText(f'{f'{self.ui_sugg_authority[0]} blocks' if self.ui_sugg_authority[0] != None else "None"}')
                        temp_cmd_item.setText(f'{f'{self.ui_cmd_authority[0]} blocks' if self.ui_cmd_authority[0] != None else "None"}')

                                # Set background
                        self.set_item_background(0, self.ui_cmd_authority[0])
                        ...
                        for i in range(33, 74):
                                ...
                                # Set background
                                self.set_item_background(i-32, self.ui_cmd_authority[i])
                        ...
                        for i in range(105, 150):
                                ...
                                # Set background
                                self.set_item_background(i-63, self.ui_cmd_authority[i])
                ...
                # Wayside 3 Data
                        ...
                        for i in range(74, 105):
                                ...
                                # Set background
                                self.set_item_background(i-74, self.ui_cmd_authority[i])
        ...
        def data_table_signals(self):
                ...
                if self.WaysideSelectComboBox.currentIndex() == 1 or self.WaysideSelectComboBox.currentIndex() == 3:
                        ...
                        # Set section text
                        for i, j in zip([2, 2, 17, 17], [1, 5, 1, 5]):
                        ...
                        # Set light outlines
                        for col, row in zip([0, 4, 0, 4], [0, 0, 15, 15]):
                                for j in range(1 + col, 4 + col):
                                        for i in range(4 + row, 14 + row):
                                                self.DataTable.updateCellColor(i, j, QColor('black'))

                # Wayside 2 light setup
                elif self.WaysideSelectComboBox.currentIndex() == 2:
                        ...
                        item = QtWidgets.QTableWidgetItem()
                        self.copy_table_widget_item(temp_text_sec_item, item)
                        self.DataTable.setItem(2, 5, item)

                        item = QtWidgets.QTableWidgetItem()
                        self.copy_table_widget_item(temp_text_sec_item, item)
                        self.DataTable.setItem(17, 1, item)

                        # Set light outlines
                        for col, row in zip([0, 4, 0], [0, 0, 15]):
                                for j in range(1 + col, 4 + col):
                                        for i in range(4 + row, 14 + row):
                                                self.DataTable.updateCellColor(i, j, QColor('black'))

                # Wayside 1 signal data
                if self.WaysideSelectComboBox.currentIndex() == 1:
        ...
        def data_table_occupancy(self):
                ...
                if self.WaysideSelectComboBox.currentIndex() == 1:
                        ...
                        for i in range(1, 33):
                                ...
                                # Set item information
                                block_item.setText(f"{i if i != 7 else '7b'}")
                                occupancy_item.setText(f'{'Occupied' if self.ui_occupancy[i] else "Vacant"}')

                                # Set items
                                self.DataTable.setItem(i-1, 0, block_item)
                                self.DataTable.setItem(i-1, 1, occupancy_item)
                        ...
                        self.copy_table_widget_item(temp_occupancy_item, occupancy_item)
                                ...
                                # Set item information
                        block_item.setText("7a")
                        occupancy_item.setText(f'{'Occupied' if self.ui_occupancy[151] else "Vacant"}')

                                # Insert row
                        self.DataTable.insertRow(6)

                                # Set items
                        self.DataTable.setItem(6, 0, block_item)
                        self.DataTable.setItem(6, 1, occupancy_item)
                        ...
                        self.copy_table_widget_item(temp_occupancy_item, occupancy_item)
                                ...
                                # Set item information
                        block_item.setText(f"{150}")
                        occupancy_item.setText(f'{'Occupied' if self.ui_occupancy[150] else "Vacant"}')
                        
                                # Set items
                        self.DataTable.setItem(33, 0, block_item)
                        self.DataTable.setItem(33, 1, occupancy_item)

                        # Set item backgrounds
                        for i in range(34):

                                # Get number from item text
                                translated_value = self.DataTable.item(i, 1).text()

                                # Set background
                                self.set_item_background_occupancy(i, 1 if translated_value == 'Occupied' else 0)
                ...
                # Wayside 2 Data
                        ...
                        self.copy_table_widget_item(temp_occupancy_item, occupancy_item)
                                ...
                                # Set item information
                        block_item.setText(f"{'Yard'}")
                        occupancy_item.setText(f'{'Occupied' if self.ui_occupancy[0] else "Vacant"}')

                                # Set background
                        self.set_item_background_occupancy(0, self.ui_occupancy[0])

                                # Set items
                        self.DataTable.setItem(0, 0, block_item)
                        self.DataTable.setItem(0, 1, occupancy_item)
                        ...
                        for i in range(33, 74):
                                ...
                                # Set background
                                self.set_item_background_occupancy(i-32, self.ui_occupancy[i])

                                # Set items
                                self.DataTable.setItem(i-32, 0, block_item)
                                self.DataTable.setItem(i-32, 1, occupancy_item)
                        ...
                        for i in range(105, 150):
                                ...
                                # Set background
                                self.set_item_background_occupancy(i-63, self.ui_occupancy[i])

                                # Set items
                                self.DataTable.setItem(i-63, 0, block_item)
                                self.DataTable.setItem(i-63, 1, occupancy_item)
                ...
                # Wayside 3 Data
                        ...
                        for i in range(74, 105):
                                ...
                                # Set background
                                self.set_item_background_occupancy(i-74, self.ui_occupancy[i])

                                # Set items
                                self.DataTable.setItem(i-74, 0, block_item)
                                self.DataTable.setItem(i-74, 1, occupancy_item)
        ...
        def data_table_crossings(self):
                ...
                # Set crossing frame
                if self.WaysideSelectComboBox.currentIndex() != 3 and self.WaysideSelectComboBox.currentIndex() != 0:
...
if __name__ == "__main__":
    ...
    Wayside_Controller = QtWidgets.QMainWindow()
    ui = wayside_ui_green_line(Wayside_Controller)
    #Wayside_Controller.show()
    sys.exit(app.exec())